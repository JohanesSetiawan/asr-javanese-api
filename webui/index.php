            ...
            <div class="row g-5">
                ...
                <div class="col-md-6">
                    ...
                    <ul>
                        ...
                        <ul class="icon-list">
                            <li class="text-body-secondary"><i>Role: <b>Assistant Team Developer</b> | Build Frontend JAWIR Website | Tester </i></li>
                        </ul>
                        <li>Shaka Arisya</li>
                        <ul class="icon-list">
                            <li class="text-body-secondary"><i>Role: <b>Assistant Team Developer</b> | Pre-processing Dataset | Tester</i></li>
                        </ul>
                        <li>Dionisious Avedo Priyantoro</li>
                        <ul class="icon-list">
                            <li class="text-body-secondary"><i>Role: <b>Assistant Team Developer</b> | Optimalization Model | Tester</i></li>
                        </ul>
                        <li>Itsna Maulana Hasan</li>
                        <ul class="icon-list">
                            <li class="text-body-secondary"><i>Role: <b>Assistant Team Developer</b> | Creating Dataset | Build Backend API Model | Tester</i></li>
                        </ul>
                        <li>Johanes Setiawan</li>
                        <ul class="icon-list">
                            <li class="text-body-secondary"><i>Role: <b>Leader Team Developer</b> | Build and Training JAWIR Deep Learning | Tester</i></li>
                        </ul>
                    </ul>
                    <div class="mb-5">
                        <h2>Logout</h2>
                        <p>Mengakhiri sesi login</p>
